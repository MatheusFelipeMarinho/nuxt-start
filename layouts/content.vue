<template>
  <div class="relative flex min-h-screen">
    ...
    <div class="flex z-40">
      <!-- Sidebar -->
      <div
        class="flex top-0 h-screen z-20"
      ...
      >
        ...
        <div
          ref="content"
          class="transition-all duration-700 bg-black overflow-hidden"
          :class="[open ? 'max-w-lg' : 'max-w-0']"
        >
          <div class="w-64 px-6 py-8">
            <div class="w-3/4 text-top font-bold text-xl text-white">
            ...
            <div class="mt-12">
              ...
              <div class="mt-2 font-medium text-md text-gray-500">
                <span class="mr-2">
         ...
         <div class="mx-6 border-t border-gray-600"></div>
          <slot></slot>
        </div>
      </div>
    </div>
    ...
    <div class="flex-1">
      <div class="bg-444426 shadow px-2 py-4">Header</div>
